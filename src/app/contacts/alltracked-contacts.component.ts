...
@Component({
    ...
    templateUrl: './alltracked-contacts.component.html',
    styleUrls: ['./alltracked-contacts.component.css']
})
export class AllTrackedContactsComponent implements OnInit {
    showDialog = false;
    ...
    private loadContacts(): void {
        ...
        this.http.get<any[]>(`${environment.apiUrl}/alltrackedcontacts/${orgId}`).subscribe({
            next: (data) => {
    ...
    private loadEmployees(): void {
        ...
        this.http
            ...
            .subscribe({
                next: (data) => this.employees = data.filter(emp => emp.isactive !== false),
